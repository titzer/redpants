...
#ifndef _DESCTABLES_H_
#define _DESCTABLES_H_
...
#define D_32BIT    0x40	  /* Default to 32 bit mode           */
#define D_4KPAGE   0x80	  /* Limit is in 4K units             */
...
#define stnd_desc(base, limit, control) {desc: {(limit & 0xffff), (base & 0xffff), \
                                         ((base >> 16) & 0xff), ((control|D_PRESENT) >> 8), \
                                         (limit >> 16), ((control & 0xff) >> 4), (base >> 24)}}
